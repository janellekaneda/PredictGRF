...
for subj in subjects:
    ...
    for gait_type in gait_types:
        ...
        for step in steps_list:
            ...
            ikrespath = os.path.join(BASE_DIR, 'data', 'raw', 'OAGR_DownSampledFiles', ('Subject_' + subj), gait_type, ('results_ik_step' + step + '_Fs60.sto'))
            ...
            grpath = os.path.join(BASE_DIR, 'data', 'raw', 'OAGR_DownSampledFiles', ('Subject_' + subj), gait_type, ('forces_step' + step + '_Fs60.mot'))
            ...
            if not os.path.exists(outdir):
               os.makedirs(outdir)
            outfilename = ('Subject_' + subj + '_' + gait_type + '_step' + step + '_INPUT_OUTPUT.npy')
