...
def get_gr_features(dataset, leg, grpath, bodymass, height):
    ...
    if dataset =='oagr':
        ...
        if 'dj' in grpath and 'll' and 'rl' not in grpath:
        ...
        elif 'rldj' in grpath or leg == 'R': # right leg drop jump, or for cutting, unant_cut, and sld: all on dominant leg
        ...
        elif 'lldj' in grpath or leg == 'L': # left leg drop jump, or for cutting, unant_cut, and sld: all on dominant leg
            grf_l_ix = [labels.index('2_ground_force_vx'), labels.index('2_ground_force_vy'), labels.index('2_ground_force_vz')]
            grm_l_ix = [labels.index('2_ground_torque_x'), labels.index('2_ground_torque_y'), labels.index('2_ground_torque_z')]
