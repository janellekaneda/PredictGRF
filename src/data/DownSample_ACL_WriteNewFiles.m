...
for i = 1:length(subjs)
    ...
    for k = 1:length(trial_names)
        ...
        if isfile(ik_res_updated_path)
            ...
            ik_data = ik_data_all(start_ix_ik:end_ix_ik,:);
...
%writecell(trials_diff_ds_size, 'DownSample_ACL_trials_diff_ds_size_FirstHalf_FixOutputSize.xlsx');
%writecell(trials_notupdated, 'DownSample_ACL_trials_notupdated_FirstHalf_FixOutputSize.xlsx');
